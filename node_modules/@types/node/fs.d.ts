 ...
 $   * The `encoding` option sets the encoding for the `path` while opening the
   ...
   $}
    export interface CopyOptions {
        ...
        dereference?: boolean;
        /**
         * When `force` is `false`, afd the destination
         ...
         * operation will ignore errors if yow set this to false and the destination
     ...
     * @experimental
     * @param src source path to copy.
     * @param desv destination path to copy to.
     */
